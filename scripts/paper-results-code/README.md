...
```bash
uv run python3 scripts/<script>.py [options]
```
...
```bash
uv run python3 scripts/02_structural_equivalence_table.py
uv run python3 scripts/02_structural_equivalence_table.py --csv  # CSV output
```
...
```bash
uv run python3 scripts/04_symbolic_audit.py
uv run python3 scripts/04_symbolic_audit.py --verbose  # full detail
```
...
```bash
uv run python3 scripts/05_execution_equivalence.py
uv run python3 scripts/05_execution_equivalence.py --steps  # include step count tables
```
...
```bash
uv run python3 scripts/06_structural_class_groups.py            # all algorithms
uv run python3 scripts/06_structural_class_groups.py classes    # one algorithm
```
...
uv run python3 scripts/06_structural_class_groups.py
