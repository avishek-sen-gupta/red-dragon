...
""",
    ...
    def test_pointer_parameter_type(self):
        ...
        param_types = dict(env.get_func_signature(FuncName("f")).params)
...
class TestCReturnType:
    def test_function_label_has_return_type(self):
        ...
        assert env.get_func_signature(FuncName("add")).return_type == "Int"
...
class TestPascalReturnType:
    ...
    def test_procedure_has_no_return_type(self):
        ...
        assert env.get_func_signature(FuncName("greet")).return_type == ""
...
class TestVarTypeScopingCrossLanguage:
    ...
    def test_same_var_name_different_types_scoped(self, scoping_lang):
        ...
        assert (
            env.get_func_signature(FuncName("make_str"), **class_kw).return_type
            == expected_str
        )
...
"""
        ...
        if not func_labels:
            ...
            labels = [
                ...
                and i.label
                and i.label.starts_with("func_add")
            ]
