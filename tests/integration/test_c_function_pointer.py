...
"""
        vars_ = _run_c(source)
        assert vars_[VarName("r1")] == 13
        assert vars_[VarName("r2")] == 7
...
"""
        vars_ = _run_c(source)
        assert vars_[VarName("r1")] == 5
        assert vars_[VarName("r2")] == 30
...
"""
        vars_ = _run_c(source)
        assert vars_[VarName("r1")] == 5, "get_op(1) should return &add: 2+3=5"
        assert vars_[VarName("r2")] == 6, "get_op(0) should return &mul: 2*3=6"
...
"""
        vars_ = _run_c(source)
        assert vars_[VarName("r0")] == 13
        assert vars_[VarName("r1")] == 7
        assert vars_[VarName("r2")] == 30
...
"""
        vars_ = _run_c(source)
        assert vars_[VarName("result")] == 13
...
"""
        ...
        assert vars_[VarName("result")] == 120
