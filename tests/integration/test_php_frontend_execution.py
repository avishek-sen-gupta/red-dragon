...
def _run_php(source: str, max_steps: int = 500) -> dict:
    return run_locals(source, Language.PHP, max_steps)
...
?>""")
        assert vars_[VarName("$result")] == 25
