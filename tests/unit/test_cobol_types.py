...
class TestCobolTypeDescriptor:
    @covers(CobolFeature.PIC_CLAUSE, CobolFeature.USAGE_DISPLAY)
    ...
    @covers(CobolFeature.PIC_CLAUSE, CobolFeature.USAGE_COMP_3)
    ...
    @covers(CobolFeature.PIC_CLAUSE, CobolFeature.USAGE_COMP)
    ...
    @covers(CobolFeature.PIC_CLAUSE, CobolFeature.USAGE_COMP_1)
    ...
    @covers(CobolFeature.PIC_CLAUSE, CobolFeature.USAGE_COMP_2)
