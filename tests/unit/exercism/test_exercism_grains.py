"""Exercism test: grains across all 15 deterministic frontends.

Uses canonical test data from Exercism problem-specifications.
Each language solution is a separate file under exercises/grains/solutions/.

Two functions per solution: square(n), total().
The canonical test cases cover both properties; the execution test
...
# Both function names are single words — identical across conventions.
...
DEFAULT_FN_SNAKE = "square"
DEFAULT_FN_CAMEL = "square"
