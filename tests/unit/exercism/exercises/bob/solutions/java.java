class M {
    static int isUpperChar(String c) {
        if (c == "A") { return 1; }
        if (c == "B") { return 1; }
        if (c == "C") { return 1; }
        if (c == "D") { return 1; }
    ...
    static int isLowerChar(String c) {
        if (c == "a") { return 1; }
        if (c == "b") { return 1; }
        if (c == "c") { return 1; }
        if (c == "d") { return 1; }
    ...
    static String response(String heyBob, int n) {
        int hasContent = 0;
        int hasUpper = 0;
        int hasLower = 0;
        String lastNonSpace = "";
    ...
    static String answer = response("Tom-ay-to, tom-aaaah-to.", 24);
}
