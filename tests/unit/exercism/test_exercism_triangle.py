"""Exercism test: triangle across all 15 deterministic frontends.
...
PROPERTY_FUNCTIONS: dict[str, tuple[str, str]] = {
    "equilateral": ("is_equilateral", "isEquilateral"),
    "isosceles": ("is_isosceles", "isIsosceles"),
    "scalene": ("is_scalene", "isScalene"),
}

# The default function in each solution file
DEFAULT_FN_SNAKE = "is_equilateral"
DEFAULT_FN_CAMEL = "isEquilateral"
...
class TestTriangleCrossLanguage:
