"""Exercism test: leap year across all 15 deterministic frontends.

Uses canonical test data from Exercism problem-specifications.
Each language solution is a separate file under exercises/leap/solutions/.
"""
...
def _function_name(language: str) -> str:
    """Return the leap-year function name for *language*."""
    return "leap_year" if language in SNAKE_CASE_LANGUAGES else "leapYear"
