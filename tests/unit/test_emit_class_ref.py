...
class TestEmitClassRef:
    def test_registers_in_symbol_table_no_parents(self):
        ctx = _make_ctx()
        ctx.emit_class_ref("Dog", "class_Dog_0", [], result_reg=Register("%0"))
    ...
    def test_registers_in_symbol_table_with_parents(self):
        ctx = _make_ctx()
        ctx.emit_class_ref("Dog", "class_Dog_0", ["Animal"], result_reg=Register("%0"))
        ref = ctx.class_symbol_table["class_Dog_0"]
    ...
    def test_no_angle_brackets_in_operand(self):
        ctx = _make_ctx()
        ctx.emit_class_ref("Dog", "class_Dog_0", ["Animal"], result_reg=Register("%1"))
    ...
    def test_multiple_registrations(self):
        ctx = _make_ctx()
        ctx.emit_class_ref("Dog", "class_Dog_0", ["Animal"], result_reg=Register("%0"))
        ctx.emit_class_ref("Cat", "class_Cat_0", [], result_reg=Register("%1"))
    ...
    def test_parents_converted_to_tuple(self):
        ...
        ctx = _make_ctx()
        ctx.emit_class_ref("C", "class_C_0", ["A", "B"], result_reg=Register("%0"))
