...
class CSharpFrontend(BaseFrontend):
    ...
    def _build_expr_dispatch(
        ...
        return {
            ...
            NT.INTEGER_LITERAL: csharp_expr.lower_csharp_integer_literal,
            NT.REAL_LITERAL: csharp_expr.lower_csharp_real_literal,
            NT.STRING_LITERAL: csharp_expr.lower_csharp_string_literal,
            NT.CHARACTER_LITERAL: csharp_expr.lower_csharp_char_literal,
            NT.VERBATIM_STRING_LITERAL: csharp_expr.lower_csharp_verbatim_string_literal,
            NT.CONSTANT_PATTERN: csharp_expr.lower_csharp_constant_pattern,
            ...
            NT.DEFAULT_EXPRESSION: csharp_expr.lower_csharp_default_expression,
            NT.SIZEOF_EXPRESSION: csharp_expr.lower_csharp_sizeof_expression,
