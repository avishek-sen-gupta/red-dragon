...
class PythonFrontend(BaseFrontend):
    ...
    def _build_expr_dispatch(
        ...
        return {
            ...
            PythonNodeType.INTEGER: common_expr.lower_int_literal,
            PythonNodeType.FLOAT: common_expr.lower_float_literal,
            PythonNodeType.STRING: py_expr.lower_python_string,
            PythonNodeType.CONCATENATED_STRING: py_expr.lower_python_concatenated_string,
            ...
            PythonNodeType.SUBSCRIPT: py_expr.lower_python_subscript,
            ...
            PythonNodeType.FORMAT_SPECIFIER: py_expr._lower_text_as_string,
            PythonNodeType.STRING_CONTENT: py_expr._lower_text_as_string,
            PythonNodeType.STRING_START: py_expr._lower_text_as_string,
            PythonNodeType.STRING_END: py_expr._lower_text_as_string,
            PythonNodeType.TYPE_CONVERSION: py_expr._lower_text_as_string,
            PythonNodeType.ELLIPSIS: py_expr.lower_python_ellipsis,
