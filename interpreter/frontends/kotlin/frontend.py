...
class KotlinFrontend(BaseFrontend):
    ...
    def _build_expr_dispatch(
        ...
        return {
            ...
            KNT.INTEGER_LITERAL: kotlin_expr.lower_kotlin_int_literal,
            KNT.LONG_LITERAL: kotlin_expr.lower_kotlin_int_literal,
            KNT.REAL_LITERAL: kotlin_expr.lower_kotlin_float_literal,
            KNT.CHARACTER_LITERAL: kotlin_expr.lower_kotlin_char_literal,
            ...
            KNT.HEX_LITERAL: kotlin_expr.lower_kotlin_int_literal,
            ...
            KNT.LABEL: kotlin_expr.lower_kotlin_label,
