...
class PhpFrontend(BaseFrontend):
    ...
    def _build_expr_dispatch(
        ...
        return {
            ...
            PHPNodeType.INTEGER: common_expr.lower_int_literal,
            PHPNodeType.FLOAT: common_expr.lower_float_literal,
            PHPNodeType.STRING: php_expr.lower_php_single_quoted_string,
            ...
            PHPNodeType.NOWDOC: php_expr.lower_php_nowdoc,
