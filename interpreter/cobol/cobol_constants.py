...
class BuiltinName:
    ...
    INTEGER = "__integer"
    INTEGER_PART = "__integer_part"
    FRACTION_PART = "__fraction_part"
    REM = "__rem"
    ...
    CHAR = "__char"
    ORD = "__ord_char"
    DAY_OF_INTEGER = "__day_of_integer"
    INTEGER_OF_DAY = "__integer_of_day"
    ANNUITY = "__annuity"
    PRESENT_VALUE = "__present_value"
    DATE_TO_YYYYMMDD = "__date_to_yyyymmdd"
    DAY_TO_YYYYDDD = "__day_to_yyyyddd"
    YEAR_TO_YYYY = "__year_to_yyyy"
