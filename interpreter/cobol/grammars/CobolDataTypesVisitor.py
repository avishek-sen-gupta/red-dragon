...
class CobolDataTypesVisitor(ParseTreeVisitor):
    ...
    def visitLeftSideAlphanumericIndicator(self, ctx:CobolDataTypes.LeftSideAlphanumericIndicatorContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by CobolDataTypes#rightSideAlphanumericIndicator.
    def visitRightSideAlphanumericIndicator(self, ctx:CobolDataTypes.RightSideAlphanumericIndicatorContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by CobolDataTypes#onlyLeftOfDecimalPoint.
    def visitOnlyLeftOfDecimalPoint(self, ctx:CobolDataTypes.OnlyLeftOfDecimalPointContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by CobolDataTypes#onlyRightOfDecimalPoint.
    def visitOnlyRightOfDecimalPoint(self, ctx:CobolDataTypes.OnlyRightOfDecimalPointContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by CobolDataTypes#bothSidesOfDecimalPoint.
    def visitBothSidesOfDecimalPoint(self, ctx:CobolDataTypes.BothSidesOfDecimalPointContext):
        return self.visitChildren(ctx)
    ...
    def visitAlphaNumericIndicator(self, ctx:CobolDataTypes.AlphaNumericIndicatorContext):
        return self.visitChildren(ctx)
    ...
    def visitLeadingScalingIndicator(self, ctx:CobolDataTypes.LeadingScalingIndicatorContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by CobolDataTypes#trailingScalingIndicator.
    def visitTrailingScalingIndicator(self, ctx:CobolDataTypes.TrailingScalingIndicatorContext):
        return self.visitChildren(ctx)
